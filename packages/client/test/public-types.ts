...
declare const requestCodec: BodyCodec<TypedRequest>
declare const responseCodec: BodyCodec<TypedResponse>
...
const typedEndpoint = endpoint("orders", "Quote", requestCodec, responseCodec)
const typedResponse: Promise<TypedResponse> = client.call(background(), typedEndpoint, {
  currency: "USD"
})
