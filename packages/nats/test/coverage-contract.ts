...
const RequiredSources = new Set([
  "src/broker-message.ts",
  "src/broker-runtime.ts",
  "src/broker.ts",
  "src/index.ts",
  "src/jetstream-broker.ts",
  "src/jetstream.ts",
  "src/server.ts"
])
...
if (seen.size !== RequiredSources.size) {
  throw new Error("LCOV does not contain exactly the seven required executable source files")
}
