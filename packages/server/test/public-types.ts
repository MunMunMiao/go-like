...
declare const numberCodec: BodyCodec<number>
...
const increment = typedEndpoint("calculator", "increment", numberCodec, numberCodec)
...
// @ts-expect-error Typed handler responses must match the Endpoint response codec.
