...
// @ts-expect-error A transformed Config cannot be substituted for a boolean-root Config.
const incompatibleConfig: Config<{ readonly enabled: boolean }> = transformed
void incompatibleConfig
