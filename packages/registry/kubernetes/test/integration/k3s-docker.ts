...
async function main(): Promise<void> {
  ...
  console.log(
    `LIKEGO_KUBERNETES_DOCKER_V2=${JSON.stringify({
      valid: true,
      image: Image,
      ...
      scenarios: [
        ...
        "kubernetes-resourceversion-cas",
        "kubernetes-namespace-foreign-isolation",
        "kubernetes-watch-410-recovery"
      ],
      resourceVersionCas: true,
      staleWatchRecovery: true,
      foreignIsolation: true,
      podOwnerGarbageCollected: true,
      cleanup: {
        managedEndpointSlices: 0,
        namespaces: 0,
