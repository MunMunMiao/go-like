...
对应 `owner.json`：Queue 为 `application-owned / native-borrowed / application-owned`；Worker 为
...
本包固定 BullMQ 5.81.2。Docker 门禁使用固定 digest 的 Redis 8.8.1，通过应用层官方三参数 processor 实际验证：
