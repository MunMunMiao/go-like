...
Formato, Lint, tipos, build, Runtime E2E, Provider E2E, Example E2E, Published, Soak, Documentation build y Audit deben registrarse por separado. `test:unit:coverage` solo genera un informe opcional; consulta la [Verification canónica en inglés](/reference/verification) para las lanes, el baseline histórico y el run record documental.
