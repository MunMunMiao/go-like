...
| C26 | Bun `1.3.14`, Node `26.x`, Deno `2.9.4`, TypeScript `7.0.2`, and k6 `2.1.0` are the declared validation versions | `source`         | `e2e/runtime-versions.ts` and `doc/reference/verification.md`                                                                                           |
