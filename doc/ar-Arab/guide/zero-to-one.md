...
الحزم هي اعتماديات workspace في هذا checkout. يسجّل المستودع Bun `1.x` وNode.js `26.x` وDeno بلا متطلب إصدار ثابت وTypeScript `7.0.2` وk6 `2.1.0` ضمن مصفوفة التحقق؛ أي إصدار من Bun 1.x أو Node.js 26.x مقبول، ويظل Deno خاضعاً للاختبار والاستكشاف من دون فرض إصدار محدد من المستودع. وتقول وثائق الحزم الحالية إن الحزم لم تُنشر بعد إلى npm.
