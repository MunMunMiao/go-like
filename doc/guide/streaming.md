...
For public HTTP endpoints, use `@likego/web` and the framework adapter you already prefer. Hono, Elysia, and H3 can create SSE, streamed responses, or runtime-specific WebSocket upgrades directly. LikeGo only preserves their native `Request`, `Response`, stream, and error identity.
