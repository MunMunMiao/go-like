...
| 组件            | 当前仓库真实 pin                                                                                               | 用途                                        |
| --------------- | -------------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
| Redis           | `redis:8.8.1-alpine@sha256:8096655e437712b07503796fb64d81359256cfcff0ab29d95a7da72863786efb`，E2E 回读为 8.8.1 | BullMQ queue、lock、retry 与 stalled 状态。 |
...
真实 Docker E2E 覆盖 Redis 8.8.1 与固定 image digest、
