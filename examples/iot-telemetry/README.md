...
bun run --filter @likego/example-iot-telemetry test
bun run --filter @likego/example-iot-telemetry test:docker
```

Docker E2E 使用固定 digest 的 NATS 2.14.3，真实验证 PubAck、explicit ack、DLQ、redelivery、
