...
| NATS JetStream | `docker.io/library/nats:2.14.3-alpine@sha256:c11af972c99ae542de8925e6a7d9c533aa1eb039660420d2074beed6089b3bf0`，启动参数至少包含 `-js -sd /data` 并挂载持久 volume。 | E2E 回读为 NATS Server `2.14.3`；NATS JS packages 固定为 `3.4.0`。升级时同时更新 tag、digest、版本断言和重连/JetStream E2E。         |
