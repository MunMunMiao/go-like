...
if (kind !== "vanilla") builtPackages.push(`@likego/${kind}`)
...
if (kind === "hono") {
  vendorPackages.push({ name: "hono", source: resolve(root, "packages/hono/node_modules/hono") })
}
if (kind === "h3") {
  vendorPackages.push({ name: "h3", source: resolve(root, "packages/h3/node_modules/h3") })
}
if (kind === "elysia") {
  vendorPackages.push({
    name: "elysia",
