...
const Definitions: readonly SuiteDefinition[] = Object.freeze([
  ...
  suite("hono-bridge-dist", "packages/hono", ["bun", "run", "test:e2e:bridge-dist"], 60_000, [
    "bun",
    "node"
  ]),
  suite("h3-bridge-dist", "packages/h3", ["bun", "run", "test:e2e:bridge-dist"], 60_000, [
    "bun",
    "node"
  ]),
  suite("elysia-bridge-dist", "packages/elysia", ["bun", "run", "test:e2e:bridge-dist"], 60_000, [
    "bun",
    "node"
  ]),
